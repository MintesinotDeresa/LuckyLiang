...
export default function ProductDetailClient({
    ...
    const SPEC_MAP: Record<string, { label: string; icon: React.ElementType }> =
        {
    ...
    return (
        <div className="container mx-auto py-8 px-10">
            ...
            <div className="grid grid-cols-1 mx-auto lg:grid-cols-2 gap-8 mb-16 ">
                ...
                <div className="space-y-5">
                    <div>
                        ...
                        <h1 className="font-serif text-3xl font-bold mb-3 text-balance">
                            {product.name}
                        </h1>
                    ...
                    <Card className="bg-muted/50">
                        <CardContent className="p-4 space-y-2 text-sm">
                            <p className="flex items-center gap-2">
                                <span className="font-semibold">✓</span> Fast
