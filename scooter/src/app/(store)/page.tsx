        ...
        <div className="min-h-screen flex flex-col   ">
            <main className="flex-1">
                <section className="relative text-white flex flex-col flex-grow items-stretch overflow-hidden h-full">
                    ...
                    <div className="container mx-auto relative z-10 flex flex-col flex-grow items-center justify-center px-6 md:px-10 py-10 min-h-[calc(100vh-70px)] ">
                    ...
                    <div className="max-w-7xl mx-auto px-6">
                        <div className="text-center mb-16 max-w-3xl mx-auto">
                            ...
                            <p className="mt-4 text-xl text-gray-400">
                                Experience the next generation of personal
                                transportation.
                            </p>
                        </div>
                        ...
                        <div className="grid md:grid-cols-3 gap-10 lg:gap-16">
                            <div className="bg-gray-800 p-8 rounded-2xl shadow-xl hover:shadow-green-700/30 transition-all duration-300 transform hover:-translate-y-1 border border-gray-700">
                                <div className="flex flex-col items-center text-center space-y-5">
                                    ...
                                    <p className="text-gray-300 text-lg">
                                        Powerful motors delivering speeds up to
                                        40 mph with exceptional range.
                                        Experience the thrill of power.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="bg-gray-800 p-8 rounded-2xl shadow-xl hover:shadow-green-700/30 transition-all duration-300 transform hover:-translate-y-1 border border-gray-700">
                                <div className="flex flex-col items-center text-center space-y-5">
                                    ...
                                    <p className="text-gray-300 text-lg">
                                        ...
                                        ensure unparalleled durability and
                            ...
                            <div className="bg-gray-800 p-8 rounded-2xl shadow-xl hover:shadow-green-700/30 transition-all duration-300 transform hover:-translate-y-1 border border-gray-700">
                                <div className="flex flex-col items-center text-center space-y-5">
                                    ...
                                    <p className="text-gray-300 text-lg">
                                        Zero emissions and an energy-efficient
                                        design contribute to a cleaner, greener
                                        tomorrow.
                                    </p>
                                </div>
                            </div>
                ...
                <section className="py-8 bg-muted/30 px-10">
                    <div className="container mx-auto">
                        <div className="text-center mb-12">
                            ...
                            <p className="text-muted-foreground">
                                Find the perfect scooter for your lifestyle
                            </p>
                        </div>
                ...
                <section className="relative py-28">
                    ...
                    <div className="relative container mx-auto text-center text-white px-4">
                        ...
                        <p className="text-lg mb-8 text-white/90">
                            Join thousands of satisfied riders who have upgraded
                            their daily travel.
                        </p>
                        <Link href="/products">
                            <Button
