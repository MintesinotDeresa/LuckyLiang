        ...
        <header className="sticky top-0 z-50 w-full bg-[#0D1F3C]/90 backdrop-blur-md border-b border-white/20">
            <div className="container mx-auto flex h-16 items-center justify-between px-4 md:px-10">
                ...
                <nav className="hidden md:flex items-center space-x-8">
                    {["/products", "/categories", "/aboutus"].map(
                        (href, idx) => {
                            const label =
                                href === "/products"
                                    ? "All Products"
                ...
                <div className="hidden md:flex items-center space-x-3">
                    <Link href="/cart">
                        <Button
                            variant="ghost"
                            size="icon"
                            className="relative text-white/90 hover:text-green-500"
                        >
                ...
                <Sheet>
                    <SheetTrigger asChild className="md:hidden">
                        <Button
                            variant="ghost"
                            size="icon"
                            className="text-white/90 hover:text-green-500"
                        >
                    ...
                    <SheetContent
                        side="right"
                        className="w-[250px] py-8 bg-[#0D1F3C] text-white flex flex-col items-center"
                    >
                        <nav className="flex flex-col space-y-4 mt-8">
                            ...
                            <div className="flex flex-col space-y-2 mt-4 border-t border-white/20 pt-3">
                                ...
                                <Link
                                    href="/service/support"
                                    className="hover:text-green-500 text-base"
                                >
                                    Support
                                </Link>
                                <Link
